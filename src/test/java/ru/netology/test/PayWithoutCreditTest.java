...
public class PayWithoutCreditTest {
    HomePage homePage = new HomePage();
    PaymentPage paymentPage = new PaymentPage();

    @BeforeEach
    void shouldCleanDataBaseAndStart() {
        DataBaseHelper.cleanDataBase();
        open("http://localhost:8080", HomePage.class);
        homePage.buyWithoutCredit();
